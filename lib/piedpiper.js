...
function findWasmBinary() {
  return locateFile('piedpiper.wasm');
}
...
function call_js_progress(percent) { if (typeof self.progressCallback === 'function') { self.progressCallback(percent); } }

// Imports from the Wasm binary.
var _malloc = Module['_malloc'] = makeInvalidEarlyAccess('_malloc');
var _pp_compress = Module['_pp_compress'] = makeInvalidEarlyAccess('_pp_compress');
var _free = Module['_free'] = makeInvalidEarlyAccess('_free');
var _pp_decompress = Module['_pp_decompress'] = makeInvalidEarlyAccess('_pp_decompress');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['pp_compress'] != 'undefined', 'missing Wasm export: pp_compress');
  _pp_compress = Module['_pp_compress'] = createExportWrapper('pp_compress', 5);
  assert(typeof wasmExports['free'] != 'undefined', 'missing Wasm export: free');
  _free = Module['_free'] = createExportWrapper('free', 1);
  assert(typeof wasmExports['pp_decompress'] != 'undefined', 'missing Wasm export: pp_decompress');
  _pp_decompress = Module['_pp_decompress'] = createExportWrapper('pp_decompress', 4);
